...
import NoMatches from '../Assets/NoMatches.svg';
		...
		<>
			<Section id='all-font'>
				{!currentUserMatches.length ? (
					...
					>
						No new matches, please update your search.
					</motion.h1>
				) : (
					<motion.h1
						variants={topFade}
			...
			<Container className={classes.root}>
				{!currentUserMatches.length ? (
					<img  style={{height: '600px'}} alt='girl-searching-for-match' src={NoMatches} />
				) : sameUser ? (
