 ...
 return getProfile()
  ...
  return (
    <div id="card">
     ...
     <h2> Name: {profile.name} {profile.lastname}</h2>
     <h3>Gender: {profile.gender}</h3>
     <h3>Location:{profile.location}</h3>
     <h3>Radius:{profile.radius} miles</h3>
     <h3>Badges:{profile.badges ? <img src="https://cdn-icons-png.flaticon.com/512/1403/1403368.png" alt="" style={{width:"45px"}}/> : null}</h3>
     <a href="">
