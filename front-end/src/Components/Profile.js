...
function Profile(profile) {
  ...
  const { name, lastname, gender, location, availabledays, experience, goals, radius, image, id } = currentUserData;
  ...
  return (
    <Paper className={classes.root}>
      ...
      <div id="cardContainer">
        ...
        {(window.location.href === `http://localhost:3000/users/${id}/feed/matches` || window.location.href === `http://localhost:3000/search-results`) && (
          <h1 id="card">
          ...
          <div className="item1">
            <div className={classes.flexCenter}>
              ...
              (          
                ...
                <li>
                  <img src={calendar} alt="calendar" />
                  {profile.profile.availabledays ? `${profile.profile.availabledays[0]}, ${profile.profile.availabledays[1]}` : ""}
                </li>
              </ul>
              )}
            ...
            <li>
              ...
              (<ul>
                <li>
                  ...
                  {profile.profile.goals ? `${profile.profile.goals[0]}, ${profile.profile.goals[1]}, ${profile.profile.goals[2]}, ${profile.profile.goals[3]} ` : ""}
                </li>
              </ul>
              )}
