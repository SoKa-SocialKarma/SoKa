		...
		<div id="edit">
			...
			<form onSubmit={handleSubmit}>
				...
				<span>
					...
					<input type="text" id="goals" value={details.goals} onChange={handleChange} />
				</span>
				<span>
					<label htmlFor="experience">Experience:</label>
					<input type="text" id="experience" value={details.experience} onChange={handleChange} />
				</span>
				<span>
					<label htmlFor="activity">Activity:</label>
					<input type="text" id="activity" value={details.activity} onChange={handleChange} />
				</span>
