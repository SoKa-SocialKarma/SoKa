...
INSERT INTO users
(uuid, name, lastname, username, location, gender, radius, karma, badges, image, goals, experience, availability, matchRequests, pendingReview)
VALUES
('7CjsxCwjOARBrOC8bD2QmFrwsb62',
'Daniel', 'Naranjo', 'PompaDonpa-ETH',
'Queens, NY', 'Male', 10, 4.82, true,
'{"name":"","url":"","album":""}',
